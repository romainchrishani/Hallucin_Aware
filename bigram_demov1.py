...
#negative_log_prob = ngram_model.evaluate_whole_sentence(main_response)
#print(f"Negative Log Probability: {negative_log_prob}")
...
# Evaluate the whole sentence presence and negative log probability
